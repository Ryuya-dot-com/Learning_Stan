# STEP 2 L19完成版: 同じ参加者の2条件を結ぶ対応図
#
# 入力:
#   output/participant_condition_summary.csv（L17の成果物）
#   output/participant_differences.csv（L17の成果物）
#
# 出力:
...
message(
  "STEP 2 L19 complete: 24 paired lines, 48 points, ",
  "2100 x 1500 px PNG"
)
