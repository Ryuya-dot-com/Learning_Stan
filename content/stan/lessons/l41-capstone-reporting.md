...
教材の公開には、クリーンCI、Stan経験者の独立レビュー、適格な初学者3名以上の観察、未解決P0・P1ゼロが別に必要です。学習者の修得判定では、初回提出、修正版、支援水準、直接評価を分けます。
...
これらは提出に必要な証拠項目です。最終的な修得の合格閾値はpilot前に数値固定せず、対象者観察と独立レビューを経て定めます。
