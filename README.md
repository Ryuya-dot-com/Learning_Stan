...
- Stan編は [非公開教材パック](content/stan/README.md) でL34–L41を設計し、L34「実行経路とデータ契約」からL40「悪い幾何をモデル側から直す」までの受講用原稿7本と理解問題35問を実装しました。単回帰の縦切り、8単元32課題の文法反復、分布・リンク関数の可視化、切断モデル、PSIS-LOOによる予測モデル比較も検証中ですが、公開アプリにはまだ含まれません
